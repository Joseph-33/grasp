...
!                                Corrected Feb 2017
! Jon Grumer, Uppsala University, Jan 2022 - extension to n > 9 multiref cfgs
!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
   ...
   write (*, *)
   write (*, *) 'RCSFPREVIEW'
   write (*, *) 'This program previews a list of CSFs'
   write (*, *)
   ...
   write (*, *) 'Outputfiles: Hopefully none'
   write (*, *)
...
! Determine highest n for orbital set and highest n for each symmetry
   ...
   do i = 1, norbstrings
      ...
      ! get max principal qn
      read (orbital(i) (1:2), *, iostat=stat) nmax
...
!      Debug: Orbitals in the configuration with occupation and indicators
